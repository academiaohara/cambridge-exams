...
def get_ai_content(api_key, test_id):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            "CRITICAL: The 'text' field MUST contain at least 150 words. "
            "Count every word before returning. If the text is under 150 words, expand it before outputting."
        )},
    ...
    try:
        ...
        for attempt in range(1, MAX_ATTEMPTS + 1):
            if attempt <= 3:
                ...
                data = _expand_text(client, data, ("content", "text"), MIN_WORDS, "word-formation passage")
