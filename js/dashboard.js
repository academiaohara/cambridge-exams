  ...
  window.Dashboard = {
    ...
    renderSubpage: function(mode, expandExamId, keepPage) {
      ...
      if (mode === 'exam' || subpageView === 'byTest') {
        ...
        mainContentHtml = '<div class="exams-container">' + Dashboard._renderRandomTestCard(mode) + examListHtml + '</div>' + paginationHtml;
      } else {
        // ── By Section view ──────────────────────────────────────────────
    ...
    showConfirmDialog: function(message, onConfirm) {
      ...
      overlay.innerHTML = `
        <div class="confirm-dialog">
          <div class="confirm-dialog-prompt">
            <img src="Assets/images/Cabezasune.svg" alt="" class="confirm-dialog-mascot" aria-hidden="true">
            <div class="confirm-dialog-bubble">
              <p>${message}</p>
            </div>
          </div>
