// js/course.js
// Course section – extends window.BentoGrid with all course-related methods
  ...
  Object.assign(window.BentoGrid, {
    ...
    _openCuMcModal: function(secId, gapNum) {
      ...
      qData.options.forEach(function(opt) {
        ...
        html += '<button class="opt-btn" onclick="BentoGrid._selectCuMcAnswer(\'' + secId + '\',' + gapNum + ',\'' + letter + '\',\'' + text.replace(/\\/g, '\\\\').replace(/'/g, "\\'") + '\')">' + text + '</button>';
      });
      html += '</div>';
      body.innerHTML = html;
